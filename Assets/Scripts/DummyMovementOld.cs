...
public class DummyMovementOld : MonoBehaviour
{
    public DummyEnume state = DummyEnume.LongDistance;
    ...
    void Update()
    {
        ...
        switch (state)
        {
            case DummyEnume.None:
                break;
            case DummyEnume.LongDistance:
                {
                    ...
                    if (Vector3.Distance(targetPos, myPos) <= radiusMovement)
                    {
                        ...
                        state = DummyEnume.Near;
                    }
                }
                break;
            case DummyEnume.Near:
                {
                {
