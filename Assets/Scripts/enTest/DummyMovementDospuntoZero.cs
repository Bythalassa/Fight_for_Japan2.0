   ...
   // public Animator anim;
    ...
    void Update()
    {
       ...
       isOnCamRange = scriptCamera.IsInsideCameraBounds();
        ...
        /*Cuando calculas una dirección para lógica de detección (como el campo de visión o saber si el enemigo está a la izquierda o derecha), 
         * necesitas que el cálculo ocurra estrictamente en un plano plano (2D).*/
        /*evitar el z en las matematicas para calcular detección de enemigos o player evita errores de calculo, evitando un tercer valor no necesario 
         * en la matematica*/
