...
public class CamaraFollowDefLobby : MonoBehaviour
{
    ...
    public float radiusDeteccionZona = 4f; // que tan cerca debe estar el jugador de una posicion para activarla
    ...
    public void FollowTarget(GameObject Target) //  core
    {
        ...
        //limites d cam
        // que siempre se mueva hacia el limite izquierdo y esto no es igual a buscar al jugador? poner la cam lejos y dejar q lo busque 
        //plan move target follow player 
